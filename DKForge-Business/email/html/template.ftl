...
<head>
    ...
    <title>DKForge Business - Professional Authentication</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        <div class="email-header">
            ...
            <div class="email-subtitle">Enterprise Authentication Service</div>
        </div>
        ...
        <div class="email-footer">
            <p><strong>DKForge Business</strong></p>
            <p>Professional-Grade Security & Authentication</p>
            <div class="footer-divider"></div>
            <span class="trust-badge">✓ Certified</span>
            <span class="trust-badge">🔐 Secure</span>
            <span class="trust-badge">✓ Trusted</span>
            <div class="footer-divider"></div>
            <p>&copy; ${.now?string("yyyy")} DKForge Business. This is an automated message, please do not reply directly.</p>
        </div>
    </div>
</body>
</html>
